...
MEDIA_URL = "frontend/plots/"
MEDIA_ROOT=os.path.join(BASE_DIR,"frontend/plots/")
...
SECRET_KEY = 'django-insecure-n671=%d5)-ve*7%#d9tw2nqwc)h2d@&sh9q#q%t2acgvm2xqyn'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'frontend.context_processor.nav_bar',
            ],
        },
    },
]
